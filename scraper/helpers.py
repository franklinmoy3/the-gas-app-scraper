...
def parse_command_args():
    ...
    arg_parser.add_argument('--log-level', action='store', type=str, default='DEBUG', help='The logging level to use')
    arg_parser.add_argument('--structured-logging', action='store_true', default=False, help='Denotes whether to structure log statements')
